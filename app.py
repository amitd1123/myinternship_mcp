...
READ_MY_PALM = RichToolDescription(
    description="Give AI wallah internship status of the student ",
    use_when="When anybody asks for status of internship ai ",
...
async def status_of_internship(
   
    query: Annotated[str, Field(description="Your question aabout the status of internship")] = "Read this palm and tell me about the future"
